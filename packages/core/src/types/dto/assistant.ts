...
/** Sharing */
export const allSharingSchema = z
  .object({
    type: z.literal('all'),
  })
...
export const insertableAssistantDraftSchema = assistantDraftSchema
  .omit({
    id: true,
    createdAt: true,
    updatedAt: true,
...
export const updateableAssistantVisibilitySchema = z
  .object({
    hidden: z.boolean(),
  })
  .meta({ id: 'UpdateableAssistantVisibility' })

export const assistantSharingSchema = z
  .object({
    id: z.string(),
    assistantId: z.string(),
...
export const assistantToolSchema = z
  .object({
    id: z.string(),
    name: z.string(),
...
export const assistantUserDataSchema = z
  .object({
    pinned: z.boolean(),
...
export const assistantIdentificationSchema = z
  .object({
    id: z.string(),
    name: z.string(),
    iconUri: z.string().nullable(),
...
export const assistantUsabilitySchema = z
...
export const userAssistantSchema = z
  .object({
    id: z.string(),
    name: z.string(),
    iconUri: z.string().nullable(),
...
export const userAssistantWithMediaSchema = userAssistantSchema
  .extend({
