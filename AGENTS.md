...
- In `## Tests`, list the exact validation already performed (commands run, scope, and outcome) — this section records what was done, not what someone should do in the future. If tests were not run, simply skip the section.
